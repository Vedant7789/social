...
export default function HoChiMinhSection() {
  const images = ["/images/IMG-20250907-WA0015.jpg", "/images/IMG-20250907-WA0016.jpg", "/images/IMG-20250907-WA0017.jpg", "/images/IMG-20250907-WA0018.jpg", "/images/IMG-20250907-WA0019.jpg","/images/IMG-20250907-WA0020.jpg","/images/IMG-20250907-WA0021.jpg"];

  return (
    <section id="ho-chi-minh-section" className="relative flex min-h-fit w-full flex-col items-center justify-center md:min-h-screen bg-white text-black">
      {/* Title */}
      <span
        className="my-12 w-full text-center text-[34px] uppercase leading-tight tracking-tight md:text-[100px]"
        style={{ opacity: 1, transform: "translateY(120px) scale(0.8)" }}
      >
        Ho Chi Minh&apos;s Ultimate shisha Experience
      </span>
